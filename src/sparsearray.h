...
#define AR_TAG_PTR       0ULL   /* arString pointer (low 2 bits = 00) */
#define AR_TAG_INT       1ULL   /* Immediate signed integer (01) */
#define AR_TAG_FLOAT     2ULL   /* Immediate float (10) */
#define AR_TAG_STR       3ULL   /* Inline small string (11) */
#define AR_TAG_MASK      3ULL
