...
// Keep numerically equivalent to hdr_value_at_percentiles() (the batch form).
...
// Batch form of hdr_value_at_percentile(): resolves several percentiles in one
// pass. MUST stay numerically equivalent to hdr_value_at_percentile() (same
// count-at-percentile rounding, same per-bucket cumulative crossing, same
// lowest/highest-equivalent-value handling) -- keep the two in sync.
